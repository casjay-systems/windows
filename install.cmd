...
Copy-Item -Path "$env:userprofile\Downloads\windows\src\git\*" -Destination "$env:userprofile" -Recurse
Copy-Item -Path "$env:userprofile\Downloads\windows\src\bash\*" -Destination "$env:userprofile" -Recurse
Copy-Item -Path "$env:userprofile\Downloads\windows\src\powershell\*" -Destination "$env:userprofile\Documents\PowerShell" -Recurse
Copy-Item -Path "$env:userprofile\Downloads\windows\src\powershell\*" -Destination "$env:userprofile\Documents\WindowsPowerShell" -Recurse
